...
```{r linear_regression_boxplot, echo=FALSE, fig.cap="MISSING CAPTION!!!!!!!!!!!!!"}
# TODO:  in GGPLOT2
...
```{r ridge_data_cv, include=TRUE, echo=FALSE, fig.cap="MISSING CAPTION!!!!!!!!!!!!!}
...
```{r show_cv, include=TRUE, echo=FALSE, fig.cap="MSE", fig.cap="MISSING CAPTION!!!!!!!!!!!!!}
