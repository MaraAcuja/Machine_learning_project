...
=======
colnames(data)[117:118] <- c("Longitude", "Latitude")
>>>>>>> d572d5dfaf7b5e71e09ac587f1841b969507df4f
```
...
mp <- ggplot() + mapWorld
mp + geom_point(data = data, aes(x = Latitude, y = Longitude), color = "red", alpha = 0.5)
```
