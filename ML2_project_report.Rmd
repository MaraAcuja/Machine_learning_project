...
In the boxplot above the distributions of the baseline and the two other algorithms are displyed next to each other. It is clearly to see that the baseline is worse than the two performed algorithms. Not just the median of the baseline is higher than the other two medians but especially the 75%-Quantile is much higher than the ones from the Ridge Regression and the NN. 
...
```{r investigations_on_angles, include=TRUE}
