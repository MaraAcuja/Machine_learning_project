...
The second algorithm chosen was neural network, out hypothesis was that this one would lead better results to our problem than ridge regression  since its a parametric solution. Nevertheless, the 4 layer implementation achieved an error of 4287.664 km in the test data. While implementing it, we tried to increase hidden layers, increase number of neurons as well as  Which is better than ridge regression but not significantly. 
